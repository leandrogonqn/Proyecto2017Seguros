...
@DomainService(nature = NatureOfService.DOMAIN, repositoryFor = TipoDeCobertura.class)
public class TipoDeCoberturaRepository {
	...
	public List<TipoDeCobertura> buscarPorNombre(final String tipoDeCoberturaNombre) {
		return repositoryService.allMatches(new QueryDefault<>(TipoDeCobertura.class, "buscarPorNombre",
				"tipoDeCoberturaNombre", tipoDeCoberturaNombre.toLowerCase()));
	}

	public List<TipoDeCobertura> listarActivos() {
		return repositoryService.allMatches(new QueryDefault<>(TipoDeCobertura.class, "listarActivos"));
	}

	public List<TipoDeCobertura> listarInactivos() {
		return repositoryService.allMatches(new QueryDefault<>(TipoDeCobertura.class, "listarInactivos"));
	}
