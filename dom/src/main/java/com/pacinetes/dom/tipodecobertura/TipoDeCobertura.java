...
@javax.jdo.annotations.PersistenceCapable(identityType = IdentityType.DATASTORE, schema = "simple", table = "TiposDeCoberturas")
@javax.jdo.annotations.DatastoreIdentity(strategy = javax.jdo.annotations.IdGeneratorStrategy.IDENTITY, column = "tipoDeCoberturaId")
@javax.jdo.annotations.Queries({
		...
		@javax.jdo.annotations.Query(name = "listarActivos", language = "JDOQL", value = "SELECT "
				+ "FROM com.pacinetes.dom.simple.TiposDeCoberturas " + "WHERE tipoDeCoberturaActivo == true "),
		@javax.jdo.annotations.Query(name = "listarInactivos", language = "JDOQL", value = "SELECT "
				+ "FROM com.pacinetes.dom.simple.TiposDeCoberturas " + "WHERE tipoDeCoberturaActivo == false ") })
@javax.jdo.annotations.Unique(name = "TiposDeCoberturas_tipoDeCoberturaNombre_UNQ", members = {
		"tipoDeCoberturaNombre" })
...
public class TipoDeCobertura implements Comparable<TipoDeCobertura> {
	...
	public int compareTo(final TipoDeCobertura other) {
		return this.tipoDeCoberturaNombre.compareTo(other.tipoDeCoberturaNombre);
	}
