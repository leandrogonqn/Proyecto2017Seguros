...
public class PolizaAP extends Poliza {
	...
	public PolizaAP actualizarPolizaFechaEmision(
	...
	// polizaPago
	public PolizaAP actualizarPolizaPago(@ParameterLayout(named = "Tipo de Pago") final TipoPago polizaTipoDePago,
	...
	// polizaMotivoBaja
	public PolizaAP actualizarPolizaMotivoBaja(
	...
	// polizaImporteTotal
	public PolizaAP actualizarPolizaImporteTotal(
	...
	// riesgoAPMuerte
	public PolizaAP actualizarRiesgoAPMuerte(@ParameterLayout(named = "Muerte") final float riesgoAPMuerte) {
		setRiesgoAPMuerte(riesgoAPMuerte);
		return this;
	}
	...
	// riesgoAPInvalidez
	public PolizaAP actualizarRiesgoAPInvalidez(@ParameterLayout(named = "Invalidez") final float riesgoAPInvalidez) {
		setRiesgoAPInvalidez(riesgoAPInvalidez);
		return this;
	}
	...
	// riesgoAPAMF
	public PolizaAP actualizarRiesgoAPAMF(@ParameterLayout(named = "AMF") final float riesgoAPAMF) {
		setRiesgoAPAMF(riesgoAPAMF);
		return this;
	}
	...
	public List<DetalleTipoPago> choices7Renovacion(final String polizaNumero, final Persona polizaCliente,
			...
			final double polizaImporteTotal, final float riesgoAPMuerte, final float riesgoAPInvalidez,
	...
	public String toString() {
		return "Poliza AP Numero: " + getPolizaNumero();
	}
