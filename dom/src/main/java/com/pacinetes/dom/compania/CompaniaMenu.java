...
@DomainService(nature = NatureOfService.VIEW_MENU_ONLY, repositoryFor = Compania.class)
@DomainServiceLayout(named = "Polizas Extras", menuOrder = "40.10")
public class CompaniaMenu {

	@Action(semantics = SemanticsOf.SAFE)
	@ActionLayout(bookmarking = BookmarkPolicy.AS_ROOT, named = "Listar Todas las Compañias")
	...
	public Compania crear(@ParameterLayout(named = "Nombre") final String companiaNombre,
		...
		return companiasRepository.crear(companiaNombre, companiaDireccion, companiaTelefono);
	}
