...
@DomainService(nature = NatureOfService.VIEW, repositoryFor = DetalleTipoPago.class)
@DomainServiceLayout(named = "Tipo de pago", menuOrder = "60.1")
public class DetalleTipoPagoMenu {

	@Action(semantics = SemanticsOf.SAFE)
	@ActionLayout(bookmarking = BookmarkPolicy.AS_ROOT, named = "Listar Todos los Pagos")
	...
	public List<DetalleTipoPago> buscarPorTitular(@ParameterLayout(named = "Titular") final String tipoPagoTitular) {
