...
@DomainService(nature = NatureOfService.VIEW_MENU_ONLY, repositoryFor = Marca.class)
@DomainServiceLayout(named = "Vehiculos", menuOrder = "50.2")
public class MarcaMenu {
	...
	public Marca crear(@ParameterLayout(named = "Nombre") final String marcaNombre) {
