...
@DomainService(nature = NatureOfService.DOMAIN, repositoryFor = DebitoAutomatico.class)
public class DebitoAutomaticoRepository {
	...
	public DebitoAutomatico crear(String tipoPagoTitular, Banco debitoAutomaticoBanco, BigInteger debitoAutomaticoCbu) {
		final DebitoAutomatico object = new DebitoAutomatico(tipoPagoTitular, debitoAutomaticoBanco,
				debitoAutomaticoCbu);
	...
	public List<DebitoAutomatico> listarActivos() {
		return repositoryService.allMatches(new QueryDefault<>(DebitoAutomatico.class, "listarActivos"));
	}

	public List<DebitoAutomatico> listarInactivos() {
		return repositoryService.allMatches(new QueryDefault<>(DebitoAutomatico.class, "listarInactivos"));
	}
