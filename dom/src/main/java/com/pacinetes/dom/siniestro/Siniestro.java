...
public class Siniestro{
	...
	public Siniestro actualizarSiniestroFecha(@ParameterLayout(named="Fecha del siniestro") final Date siniestroFecha){
		setSiniestroFecha(siniestroFecha);
		return this;
	}
    ...
    public String toString() {
        return ObjectContracts.toString(this, "siniestroDescripcion");
    }
