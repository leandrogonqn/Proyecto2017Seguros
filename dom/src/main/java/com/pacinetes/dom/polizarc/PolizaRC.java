...
public class PolizaRC extends Poliza {
	...
	public PolizaRC(String polizaNumero, Persona polizaCliente, Compania polizaCompania, Date polizaFechaEmision,
			Date polizaFechaVigencia, Date polizaFechaVencimiento, TipoPago polizaTipoDePago,
			DetalleTipoPago polizaPago, double polizaImporteTotal, float riesgoRCMonto) {
	...
	public PolizaRC(String polizaNumero, Persona polizaCliente, Compania polizaCompania, Date polizaFechaEmision,
			Date polizaFechaVigencia, Date polizaFechaVencimiento, TipoPago polizaTipoDePago,
			DetalleTipoPago polizaPago, double polizaImporteTotal, Poliza riesgoRC, float riesgoRCMonto) {
		setPolizaNumero(polizaNumero);
		setPolizasCliente(polizaCliente);
		setPolizasCompania(polizaCompania);
		setPolizaFechaEmision(polizaFechaEmision);
	...
	public PolizaRC actualizarPolizaFechaEmision(
	...
	@SuppressWarnings("deprecation")
	public PolizaRC actualizarPolizaFechaVigencia(
	...
	@SuppressWarnings("deprecation")
	public PolizaRC actualizarPolizaFechaVencimiento(
	...
	// polizaPago
	public PolizaRC actualizarPolizaPago(@ParameterLayout(named = "Tipo de Pago") final TipoPago polizaTipoDePago,
	...
	// polizaMotivoBaja
	public PolizaRC actualizarPolizaMotivoBaja(
	...
	// polizaImporteTotal
	public PolizaRC actualizarPolizaImporteTotal(
	...
	// riesgoARTMonto
	public PolizaRC actualizarRiesgoRCMonto(@ParameterLayout(named = "Monto asegurado") final float riesgoRCMonto) {
		setRiesgoRCMonto(riesgoRCMonto);
		return this;
	}
	...
	public List<DetalleTipoPago> choices7Renovacion(final String polizaNumero, final Persona polizaCliente,
			...
			final double polizaImporteTotal, final float riesgoRCMonto) {
		return detalleTipoPagoMenu.buscarPorTipoDePagoCombo(polizaTipoDePago);
	}
	...
	public String toString() {
		return "Poliza RC Numero: " + getPolizaNumero();
	}
