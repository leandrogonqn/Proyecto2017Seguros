...
@DomainService(nature = NatureOfService.DOMAIN, repositoryFor = PolizaCaucion.class)
public class PolizaCaucionRepository {
	...
	public PolizaCaucion renovacion(final String polizaNumero, final Persona polizaCliente,
			...
			final double polizaImporteTotal, final float riesgoCaucionMonto, Poliza riesgoCaucion) {
		final PolizaCaucion object = new PolizaCaucion(polizaNumero, polizaCliente, polizaCompania, polizaFechaEmision,
				polizaFechaVigencia, polizaFechaVencimiento, polizaTipoDePago, polizaPago, polizaImporteTotal,
