...
public class PolizaIncendio extends Poliza {
	...
	public PolizaIncendio actualizarPolizaFechaEmision(
	...
	// polizaPago
	public PolizaIncendio actualizarPolizaPago(@ParameterLayout(named = "Tipo de Pago") final TipoPago polizaTipoDePago,
	...
	// polizaFechaBaja
	public PolizaIncendio actualizarPolizaFechaBaja(
	...
	// polizaMotivoBaja
	public PolizaIncendio actualizarPolizaMotivoBaja(
	...
	// polizaImporteTotal
	public PolizaIncendio actualizarPolizaImporteTotal(
	...
	public PolizaIncendio actualizarPolizaRenovacion(
	...
	public List<DetalleTipoPago> choices7Renovacion(final String polizaNumero, final Persona polizaCliente,
			...
			final double polizaImporteTotal, final float riesgoIncendioMonto) {
		return detalleTipoPagoMenu.buscarPorTipoDePagoCombo(polizaTipoDePago);
	}
	...
	public String toString() {
		return "Poliza Incendio Numero: " + getPolizaNumero();
	}
