...
import com.pacinetes.dom.reportes.PolizaTROReporte;
...
public class PolizaTRO extends Poliza {
	...
	public PolizaTRO(String polizaNumero, Persona polizaCliente, Compania polizaCompania, Date polizaFechaEmision,
			Date polizaFechaVigencia, Date polizaFechaVencimiento, TipoPago polizaTipoDePago,
			DetalleTipoPago polizaPago, double polizaImporteTotal, float riesgoTROMonto) {
	...
	public PolizaTRO(String polizaNumero, Persona polizaCliente, Compania polizaCompania, Date polizaFechaEmision,
			Date polizaFechaVigencia, Date polizaFechaVencimiento, TipoPago polizaTipoDePago,
			DetalleTipoPago polizaPago, double polizaImporteTotal, Poliza riesgoTRO, float riesgoTROMonto) {
		setPolizaNumero(polizaNumero);
		setPolizasCliente(polizaCliente);
		setPolizasCompania(polizaCompania);
		setPolizaFechaEmision(polizaFechaEmision);
	...
	public PolizaTRO actualizarPolizaFechaEmision(
	...
	@SuppressWarnings("deprecation")
	public PolizaTRO actualizarPolizaFechaVigencia(
	...
	@SuppressWarnings("deprecation")
	public PolizaTRO actualizarPolizaFechaVencimiento(
	...
	// polizaPago
	public PolizaTRO actualizarPolizaPago(@ParameterLayout(named = "Tipo de Pago") final TipoPago polizaTipoDePago,
	...
	// polizaMotivoBaja
	public PolizaTRO actualizarPolizaMotivoBaja(
	...
	// polizaImporteTotal
	public PolizaTRO actualizarPolizaImporteTotal(
	...
	// riesgoARTMonto
	public PolizaTRO actualizarRiesgoTROMonto(@ParameterLayout(named = "Monto asegurado") final float riesgoTROMonto) {
		setRiesgoTROMonto(riesgoTROMonto);
		return this;
	}
	...
	public String toString() {
		return "Poliza TRO Numero: " + getPolizaNumero();
	}
