...
@DomainService(nature = NatureOfService.VIEW, repositoryFor = TipoVivienda.class)
@DomainServiceLayout(named = "Polizas Extras", menuOrder = "40.50")
public class TipoViviendaMenu {
	...
	public List<TipoVivienda> buscarPorNombre(@ParameterLayout(named = "Nombre") final String tipoViviendaNombre) {
		return tipoViviendasRepository.buscarPorNombre(tipoViviendaNombre);
	}

	@ActionLayout(named = "Crear Tipo de Vivienda")
	@MemberOrder(sequence = "1.2")
	public TipoVivienda crear(
			@ParameterLayout(named = "Nombre", labelPosition = LabelPosition.TOP) final String tipoViviendaNombre) {
