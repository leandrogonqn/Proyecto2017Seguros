...
@javax.jdo.annotations.PersistenceCapable(identityType = IdentityType.DATASTORE, schema = "simple", table = "TiposVivienda")
@javax.jdo.annotations.DatastoreIdentity(strategy = javax.jdo.annotations.IdGeneratorStrategy.IDENTITY, column = "tipoViviendaId")
@javax.jdo.annotations.Queries({
		...
		@javax.jdo.annotations.Query(name = "listarActivos", language = "JDOQL", value = "SELECT "
				+ "FROM com.pacinetes.dom.simple.tipoVivienda " + "WHERE tipoViviendaActivo == true "),
		@javax.jdo.annotations.Query(name = "listarInactivos", language = "JDOQL", value = "SELECT "
				+ "FROM com.pacinetes.dom.simple.tipoVivienda " + "WHERE tipoViviendaActivo == false ") })
...
public class TipoVivienda implements Comparable<TipoVivienda> {
	...
	public TranslatableString title() {
		return TranslatableString.tr("Tipo de vivienda: {name}", "name", getTipoViviendaNombre());
	}
	// endregion
	...
	public TipoVivienda actualizarActivo(@ParameterLayout(named = "Activo") final boolean tipoViviendaActivo) {
		setTipoViviendaActivo(tipoViviendaActivo);
		return this;
	}

	public boolean default0ActualizarActivo() {
		return isTipoViviendaActivo();
	}
	...
	public int compareTo(final TipoVivienda other) {
		return this.tipoViviendaNombre.compareTo(other.tipoViviendaNombre);
	}
