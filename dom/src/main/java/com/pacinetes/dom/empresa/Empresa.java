...
@javax.jdo.annotations.PersistenceCapable(identityType = IdentityType.DATASTORE, schema = "simple", table = "Empresas")
...
@javax.jdo.annotations.Queries({
		...
		@javax.jdo.annotations.Query(name = "listarActivos", language = "JDOQL", value = "SELECT "
				+ "FROM com.pacinetes.dom.simple.Empresas " + "WHERE personaActivo == true "),
		@javax.jdo.annotations.Query(name = "listarInactivos", language = "JDOQL", value = "SELECT "
				+ "FROM com.pacinetes.dom.simple.Empresas " + "WHERE personaActivo == false ") })
...
public class Empresa extends Persona implements Comparable<Empresa> {
	...
	public Empresa(String empresaRazonSocial, String personaCuitCuil, Localidad personaLocalidad,
