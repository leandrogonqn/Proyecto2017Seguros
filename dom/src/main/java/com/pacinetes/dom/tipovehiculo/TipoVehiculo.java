...
@javax.jdo.annotations.DatastoreIdentity(strategy = javax.jdo.annotations.IdGeneratorStrategy.IDENTITY, column = "tipoVehiculoId")
@javax.jdo.annotations.Queries({
		...
		@javax.jdo.annotations.Query(name = "listarActivos", language = "JDOQL", value = "SELECT "
				+ "FROM domainapp.dom.simple.tipoVehiculo " + "WHERE tipoVehiculoActivo == true "),
		@javax.jdo.annotations.Query(name = "listarInactivos", language = "JDOQL", value = "SELECT "
				+ "FROM domainapp.dom.simple.tipoVehiculo " + "WHERE tipoVehiculoActivo == false ") })
...
public class TipoVehiculo implements Comparable<TipoVehiculo> {
	...
	public int compareTo(final TipoVehiculo other) {
		return this.tipoVehiculoNombre.compareTo(other.tipoVehiculoNombre);
	}
