...
@DomainServiceLayout(named = "Polizas Crear", menuOrder = "19.3")
public class PolizaIntegralComercioMenu {

	@Action(invokeOn = InvokeOn.OBJECT_ONLY)
	@ActionLayout(named = "Crear Poliza Integral Comercio")
	@MemberOrder(sequence = "30")
	public PolizaIntegralComercio crear(@ParameterLayout(named = "Número") final String polizaNumero,
		...
		return polizasRepository.crear(polizaNumero, polizaCliente, polizaCompania, polizaFechaEmision,
				...
				riesgoIntegralComercioRobo, riesgoIntegralComercioCristales, riesgoIntegralComercioIncendioEdificio,
				riesgoIntegralComercioIncendioContenido, riesgoIntegralComercioRc, riesgoIntegralComercioRcl,
				riesgoIntegralComercioDanioPorAgua, riesgoIntegralComercioRCC, riesgoIntegralComercioOtrosNombre,
	...
	public List<DetalleTipoPago> choices7Crear(final String polizaNumero, final Persona polizaCliente,
			...
			final double polizaImporteTotal, final float riesgoIntegralComercioRobo,
			final float riesgoIntegralComercioCristales, final float riesgoIntegralComercioIncendioEdificio,
			final float riesgoIntegralComercioIncendioContenido, final float riesgoIntegralComercioRc,
			final float riesgoIntegralComercioRcl, final float riesgoIntegralComercioDanioPorAgua,
			final float riesgoIntegralComercioRCC, final String riesgoIntegralComercioOtrosNombre,
