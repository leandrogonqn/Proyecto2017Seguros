...
public class PolizaVidaColectivoMenu {
	  ...
	  public List<PolizaVidaColectivo> listar() {
	    ...
	    public static class CreateDomainEvent extends ActionDomainEvent<PolizaVidaColectivoMenu> {}
	    ...
	    public PolizaVidaColectivo crear(
