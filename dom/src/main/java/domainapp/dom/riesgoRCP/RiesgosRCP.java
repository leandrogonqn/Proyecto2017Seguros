...
public class RiesgosRCP extends Polizas implements Comparable<RiesgosRCP> {
	 ...
	 //region > title
	   ...
	   //endregion
		...
		// Constructor
		public RiesgosRCP(String polizaNumero, Clientes polizaCliente, Companias polizaCompania,
	...
	//region > delete (action)
	   public static class DeleteDomainEvent extends ActionDomainEvent<RiesgosRCP> {}
	   @Action(
	   ...
	   //Actualizar PolizaNumero
		public RiesgosRCP actualizarPolizaNumero(@ParameterLayout(named="Numero") final String polizaNumero){
			setPolizaNumero(polizaNumero);
			return this;
		}
	   ...
	   public RiesgosRCP actualizarPolizaCliente(@ParameterLayout(named="Cliente") final Clientes polizaCliente) {
	       setPolizasCliente(polizaCliente);
	       return this;
	   }
	   ...
	   public RiesgosRCP actualizarPolizaCompania(@ParameterLayout(named="Compañia") final Companias polizaCompania) {
	   ...
	   //Actualizar polizaFechaEmision
		public RiesgosRCP actualizarPolizaFechaEmision(@ParameterLayout(named="Fecha de Emision") final Date polizaFechaEmision){
			setPolizaFechaEmision(polizaFechaEmision);
			return this;
		}
	   ...
	   //Actualizar polizaFechaVigencia
		public RiesgosRCP actualizarPolizaFechaVigencia(@ParameterLayout(named="Fecha de Vigencia") final Date polizaFechaVigencia){
			setPolizaFechaVigencia(polizaFechaVigencia);
			polizaEstado.actualizarEstado(this);
	   ...
	   //polizaFechaVencimiento
		public RiesgosRCP actualizarPolizaFechaVencimiento(@ParameterLayout(named="Fecha de Vencimiento") final Date polizaFechaVencimiento){
			setPolizaFechaVencimiento(polizaFechaVencimiento);
			polizaEstado.actualizarEstado(this);
			return this;
		}
	   ...
	   //polizaPago
	   public RiesgosRCP actualizarPolizaPago(@ParameterLayout(named="Pago") final DetalleTipoPagos polizaPago) {
	       setPolizaPago(polizaPago);
	       return this;
	   }
	   ...
	   //polizaFechaBaja
		public RiesgosRCP actualizarPolizaFechaBaja(@ParameterLayout(named="Fecha de Baja") final Date polizaFechaBaja){
	   ...
	   //polizaMotivoBaja
		public RiesgosRCP actualizarPolizaMotivoBaja(@ParameterLayout(named="Motivo de la Baja") final String polizaMotivoBaja){
	   ...
	   //polizaImporteTotal
		public RiesgosRCP actualizarPolizaImporteTotal(@ParameterLayout(named="Importe Total") final double polizaImporteTotal){
			setPolizaImporteTotal(polizaImporteTotal);
			return this;
		}
		...
		// riesgoARTMonto
		public RiesgosRCP actualizarRiesgoRCMonto(
	   ...
	   public RiesgosRCP actualizarPolizaRenovacion(@ParameterLayout(named="Renovacion") final Polizas polizaRenovacion) {
	   ...
	   public RiesgosRCP borrarPolizaRenovacion() {
	   ...
	   @Override
	   public int compareTo(final RiesgosRCP other) {
	   ...
	   @Inject
	   RiesgosRCPRepository riesgosRCPRepository;
