...
public class PolizaConvenioMercantil extends Poliza implements Comparable<PolizaConvenioMercantil>{
	 ...
	 //region > title
	   ...
	   //endregion
		...
		// Constructor
		public PolizaConvenioMercantil(String polizaNumero, Cliente polizaCliente, Compania polizaCompania,
	...
	//region > delete (action)
	   ...
	   public PolizaConvenioMercantil actualizarPolizaCliente(@ParameterLayout(named="Cliente") final Cliente polizaCliente) {
	       setPolizasCliente(polizaCliente);
	       return this;
	   }
	   ...
	   //polizaPago
	   public PolizaConvenioMercantil actualizarPolizaPago(@ParameterLayout(named="Pago") final DetalleTipoPago polizaPago) {
	       setPolizaPago(polizaPago);
	       return this;
	   }
	   ...
	   //polizaImporteTotal
		...
		// riesgoARTMonto
		public PolizaConvenioMercantil actualizarRiesgoRCMonto(
	   ...
	   @Override
	   public int compareTo(final PolizaConvenioMercantil other) {
