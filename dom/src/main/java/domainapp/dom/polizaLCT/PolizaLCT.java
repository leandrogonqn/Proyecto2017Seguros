...
public class PolizaLCT extends Poliza implements Comparable<PolizaLCT> {
   ...
   //endregion
	...
	// Constructor
	public PolizaLCT(String polizaNumero, Cliente polizaCliente, Compania polizaCompania,
...
//region > delete (action)
   ...
   public PolizaLCT actualizarPolizaCliente(@ParameterLayout(named="Cliente") final Cliente polizaCliente) {
       setPolizasCliente(polizaCliente);
       return this;
   }
   ...
   //polizaPago
   public PolizaLCT actualizarPolizaPago(@ParameterLayout(named="Pago") final DetalleTipoPago polizaPago) {
       setPolizaPago(polizaPago);
       return this;
   }
