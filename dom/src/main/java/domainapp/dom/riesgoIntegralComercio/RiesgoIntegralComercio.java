...
//    public static class DeleteDomainEvent extends ActionDomainEvent<RiesgoIntegralComercio> {}
//    @Action(
...
//    )
	...
	public RiesgoIntegralComercio actualizarRiesgoIntegralComercioIncendioContenido(@ParameterLayout(named="Incendio Contenido") final float riesgoIntegralComercioIncendioContenido){
		setRiesgoIntegralComercioIncendioContenido(riesgoIntegralComercioIncendioContenido);
		return this;
	}
	...
	public RiesgoIntegralComercio actualizarRiesgoIntegralComercioIncendioEdificio(@ParameterLayout(named="Incendio Edificio") final float riesgoIntegralComercioIncendioEdificio){
		setRiesgoIntegralComercioIncendioEdificio(riesgoIntegralComercioIncendioEdificio);
		return this;
	}
	...
	public RiesgoIntegralComercio actualizarRiesgoIntegralComercioCristales(@ParameterLayout(named="Cristales") final float riesgoIntegralComercioCristales){
		setRiesgoIntegralComercioCristales(riesgoIntegralComercioCristales);
		return this;
	}
    ...
    //Actualizar Robo
	public RiesgoIntegralComercio actualizarRiesgoIntegralComercioRobo(@ParameterLayout(named="Robo") final float riesgoIntegralComercioRobo){
		setRiesgoIntegralComercioRobo(riesgoIntegralComercioRobo);
		return this;
	}
    ...
    //Actualizar RC
	public RiesgoIntegralComercio actualizarRiesgoIntegralComercioRc(@ParameterLayout(named="RC") final float riesgoIntegralComercioRc){
		setRiesgoIntegralComercioRc(riesgoIntegralComercioRc);
		return this;
	}
    ...
    //Actualizar RCL
	public RiesgoIntegralComercio actualizarRiesgoIntegralComercioRcl(@ParameterLayout(named="RCL") final float riesgoIntegralComercioRcl){
		setRiesgoIntegralComercioRcl(riesgoIntegralComercioRcl);
		return this;
	}
	...
	public RiesgoIntegralComercio actualizarRiesgoIntegralComercioDanioPorAgua(@ParameterLayout(named="Daño por agua") final float riesgoIntegralComercioDanioPorAgua){
		setRiesgoIntegralComercioDanioPorAgua(riesgoIntegralComercioDanioPorAgua);
		return this;
	}
    ...
    public RiesgoIntegralComercio actualizarPolizaCliente(@ParameterLayout(named="Cliente") final Clientes polizaCliente) {
        setPolizasCliente(polizaCliente);
        return this;
    }
    ...
    public RiesgoIntegralComercio actualizarPolizaCompania(@ParameterLayout(named="Compañia") final Companias polizaCompania) {
	...
	public RiesgoIntegralComercio actualizarPolizaFechaEmision(@ParameterLayout(named="Fecha de Emision") final Date polizaFechaEmision){
		setPolizaFechaEmision(polizaFechaEmision);
		return this;
	}
	...
	public RiesgoIntegralComercio actualizarPolizaFechaVigencia(@ParameterLayout(named="Fecha de Vigencia") final Date polizaFechaVigencia){
		setPolizaFechaVigencia(polizaFechaVigencia);
		polizaEstado.actualizarEstado(this);
	...
	public RiesgoIntegralComercio actualizarPolizaFechaVencimiento(@ParameterLayout(named="Fecha de Vencimiento") final Date polizaFechaVencimiento){
		setPolizaFechaVencimiento(polizaFechaVencimiento);
		polizaEstado.actualizarEstado(this);
		return this;
	}
	...
	public RiesgoIntegralComercio actualizarPolizaFechaVencimientoPago(@ParameterLayout(named="Fecha Vencimiento de Pago") final Date polizaFechaVencimientoPago){
		setPolizaFechaVencimientoPago(polizaFechaVencimientoPago);
		return this;
	}
    ...
    //polizaPago
    public RiesgoIntegralComercio actualizarPolizaPago(@ParameterLayout(named="Pago") final DetalleTipoPagos polizaPago) {
        setPolizaPago(polizaPago);
        return this;
    }
	...
	public RiesgoIntegralComercio actualizarPolizaAlertaVencimientoPago(@ParameterLayout(named="Alerta Vencimiento de Pago") final boolean polizaAlertaVencimientoPago){
		setPolizaAlertaVencimientoPago(polizaAlertaVencimientoPago);
		return this;
	}
    ...
    //polizaFechaBaja
	public RiesgoIntegralComercio actualizarPolizaFechaBaja(@ParameterLayout(named="Fecha de Baja") final Date polizaFechaBaja){
    ...
    //polizaMotivoBaja
	public RiesgoIntegralComercio actualizarPolizaMotivoBaja(@ParameterLayout(named="Motivo de la Baja") final String polizaMotivoBaja){
    ...
    //polizaImporteTotal
	public RiesgoIntegralComercio actualizarPolizaImporteTotal(@ParameterLayout(named="Importe Total") final double polizaImporteTotal){
		setPolizaImporteTotal(polizaImporteTotal);
		return this;
	}
    ...
    public RiesgoIntegralComercio actualizarPolizaRenovacion(@ParameterLayout(named="Renovacion") final Polizas polizaRenovacion) {
	...
	public RiesgoIntegralComercio renovacion(
        ...
        return riesgoIntegralComercioRepository.renovacion(
        		polizaNumero, 
        		polizaCliente, 
        		polizaCompania,
        		polizaFechaEmision, 
