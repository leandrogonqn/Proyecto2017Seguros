...
public class PagoEfectivo extends DetalleTipoPago implements Comparable<PagoEfectivo> {
	 //region > title
    ...
    public static class DeleteDomainEvent extends ActionDomainEvent<PagoEfectivo> {}
    @Action(
	...
	public PagoEfectivo actualizarActivo(@ParameterLayout(named="Activo") final boolean tipoPagoActivo){
    ...
    @Override
    public int compareTo(final PagoEfectivo other) {
