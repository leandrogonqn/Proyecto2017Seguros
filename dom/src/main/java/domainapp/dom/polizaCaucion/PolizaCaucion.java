...
public class PolizaCaucion extends Poliza implements Comparable<PolizaCaucion> {
   ...
   //endregion
	...
	// Constructor
	public PolizaCaucion(String polizaNumero, Cliente polizaCliente, Compania polizaCompania,
...
//region > delete (action)
   ...
   public PolizaCaucion actualizarPolizaCliente(@ParameterLayout(named="Cliente") final Cliente polizaCliente) {
       setPolizasCliente(polizaCliente);
       return this;
   }
   ...
   //Actualizar polizaFechaEmision
	public PolizaCaucion actualizarPolizaFechaEmision(@ParameterLayout(named="Fecha de Emision") final Date polizaFechaEmision){
		setPolizaFechaEmision(polizaFechaEmision);
		return this;
	}
   ...
   //Actualizar polizaFechaVigencia
	public PolizaCaucion actualizarPolizaFechaVigencia(@ParameterLayout(named="Fecha de Vigencia") final Date polizaFechaVigencia){
		setPolizaFechaVigencia(polizaFechaVigencia);
		polizaEstado.actualizarEstado(this);
	...
	public PolizaCaucion actualizarRiesgoCaucionMonto(@ParameterLayout (named="Monto Caucion") final float riesgoCaucionMonto){
		setRiesgoCaucionMonto(riesgoCaucionMonto);
		return(this);
	}
   ...
   //polizaFechaVencimiento
	public PolizaCaucion actualizarPolizaFechaVencimiento(@ParameterLayout(named="Fecha de Vencimiento") final Date polizaFechaVencimiento){
		setPolizaFechaVencimiento(polizaFechaVencimiento);
		polizaEstado.actualizarEstado(this);
		return this;
	}
   ...
   //polizaPago
   public PolizaCaucion actualizarPolizaPago(@ParameterLayout(named="Pago") final DetalleTipoPago polizaPago) {
       setPolizaPago(polizaPago);
       return this;
   }
   ...
   //polizaFechaBaja
	public PolizaCaucion actualizarPolizaFechaBaja(@ParameterLayout(named="Fecha de Baja") final Date polizaFechaBaja){
   ...
   //polizaMotivoBaja
	public PolizaCaucion actualizarPolizaMotivoBaja(@ParameterLayout(named="Motivo de la Baja") final String polizaMotivoBaja){
   ...
   //polizaImporteTotal
	public PolizaCaucion actualizarPolizaImporteTotal(@ParameterLayout(named="Importe Total") final double polizaImporteTotal){
		setPolizaImporteTotal(polizaImporteTotal);
		return this;
	}
   ...
   public PolizaCaucion actualizarPolizaRenovacion(@ParameterLayout(named="Renovacion") final Poliza polizaRenovacion) {
   ...
   @Override
   public int compareTo(final PolizaCaucion other) {
